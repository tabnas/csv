...
#
# The engine, the jsonic base (and the JSON core it needs) and the fixture
...
# the jsonic base, the JSON core and the fixture runner). Those entries legitimately move
