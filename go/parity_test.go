...
// can the two loaders.
//
// What is left here is only what is specific to csv: how to build the
...
func TestSpec(t *testing.T) {
	...
	support.Runner{
		...
		// Flatten through JSON so *OrderedMap and Go's numeric types
		// compare against the fixture's decoded shape. Normalize runs
